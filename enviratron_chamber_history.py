...
def main():
    ...
    for i in range(1, 9):
        ...
        OUTPUT_PATH = f"./output_working/chamber_{chamber_id}_observation_data_from_{start_datetime_str}_to_{end_datetime_str}_{time_resolution}_minute_resolution.csv"
